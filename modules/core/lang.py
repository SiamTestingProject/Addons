...
from command import all_lang, zel_command, zel_sudo, my_prefix, who_message, set_global_lang, get_global_lang, get_text
...
@Client.on_message(zel_command("setlang", Module_Name, filename, "[lang]") & zel_sudo())
...
@Client.on_message(zel_command("getlang", Module_Name, filename) & zel_sudo())
