...
class AliasManager:
    ...
    def load_aliases(self):
        try:
            ...
            logging.exception("Error loading aliases: %s", e)
    ...
    def save_aliases(self):
        try:
            ...
            logging.exception("Error saving aliases: %s", e)
...
@Client.on_message(zel_command("alias", "AliasManager", os.path.basename(__file__), "[add/del/list] [alias] [command]") & zel_sudo())
