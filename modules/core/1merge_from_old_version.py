...
for _ in modules:
    try:
        if os.path.exists(f"modules/plugins_1system/{_}"):
            link = f"https://raw.githubusercontent.com/SiamTestingProject/Addons/refs/heads/main/{_}"
...
# 2.4.3
if os.path.exists("photo/zelretch_info.jpg"):
    os.remove("photo/zelretch_info.jpg")
